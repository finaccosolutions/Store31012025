...
import { ShoppingBag, Trash2, Plus, Minus, ArrowUp, ChevronDown, ChevronUp } from 'lucide-react';
            ...
            <div className="space-y-4">
              {cart.map((item) => (
                <div key={item.id} className="flex flex-col sm:flex-row items-start sm:items-center 
                                          space-y-4 sm:space-y-0 sm:space-x-4 bg-white dark:bg-gray-800 
                                          p-4 rounded-lg">
                  <Link to={`/product/${item.id}`}>
                  <img src={item.image} alt={item.name} className="w-full sm:w-24 h-40 sm:h-24 
                  ...
                  <div className="flex-1 w-full">
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center 
                                space-y-3 sm:space-y-0 sm:space-x-4 mt-4">
