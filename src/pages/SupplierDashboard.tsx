...
export default function SupplierDashboard() {
  ...
  const [activeTab, setActiveTab] = useState<'products' | 'orders' | 'pricing' | 'analytics' | 'messages'>('products');
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    <div>
                      ...
                      <div className="mt-1 relative rounded-md shadow-sm">
                        ...
                        <input
                          type="text"
                          className="block w-full pl-7 border border-gray-300 rounde d-md shadow-sm py-2 px-3 
                               focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                        />
                      </div>
                    </div>
